...
java -jar /home/caiofior/bin/compiler.jar --js /home/caiofior/Pubblici/fioriechiavi.it/js/observation.js | gzip > /home/caiofior/Pubblici/fioriechiavi.it/js/observation.min.js.gz
