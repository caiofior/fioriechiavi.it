...
class TermImage extends \Content
{
   ...
   private function moveFile($inputFile) {
      ...
      set_error_handler(function() {throw new \Exception('The file is not an image '.$inputFile,1410021647);},E_WARNING);
      ...
      set_error_handler(function() {throw new \Exception('Unable to create directory '.$destFileName,1410021647);},E_WARNING);
