...
class Autoload {
   ...
   public static function getInstance()
   {
      ...
      require __DIR__.DIRECTORY_SEPARATOR.'linkprovider'.DIRECTORY_SEPARATOR.'GoogleLink.php';
      require __DIR__.DIRECTORY_SEPARATOR.'linkprovider'.DIRECTORY_SEPARATOR.'GoogleLinkColl.php';
