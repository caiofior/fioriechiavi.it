...
class Autoload {
   ...
   public static function getInstance()
   {
      ...
      require __DIR__.DIRECTORY_SEPARATOR.'contact'.DIRECTORY_SEPARATOR.'Contact.php';
      require __DIR__.DIRECTORY_SEPARATOR.'contact'.DIRECTORY_SEPARATOR.'ContactColl.php';
